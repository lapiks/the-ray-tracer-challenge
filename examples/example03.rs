...
use ray_tracer::{Camera, World, Object, shapes::{Sphere, Shape, Plane}, Color, Material, PointLight, transformations, Pattern, pattern::{PlainPattern, PatternObject, StrippedPattern}};
        ...
        .with_material(
            Material::default()
                .with_pattern(
                    ...
                    .with_transform(
                        &(DMat4::from_rotation_z(PI / 2.0) * DMat4::from_scale(dvec3(0.2, 0.2, 0.2)))
                    )
                )
                .with_diffuse(0.7)
                .with_specular(0.3)
